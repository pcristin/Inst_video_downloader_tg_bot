...
class Settings(BaseSettings):
    ...
    INLINE_FREE_SUCCESSFUL_DELIVERIES: int = 3
    INLINE_SUBSCRIPTION_AUTO_REFUND_FAILURE_THRESHOLD: float = 0.30
    ...
    USER_RATE_LIMIT_REQUESTS: int = 10
    USER_RATE_LIMIT_WINDOW_SECONDS: int = 10 * 60
    TELEGRAM_CONCURRENT_UPDATES: int = 4
    TELEGRAM_CONNECTION_POOL_SIZE: int = 16
    TELEGRAM_MEDIA_WRITE_TIMEOUT_SECONDS: float = 60.0
    TELEGRAM_MEDIA_READ_TIMEOUT_SECONDS: float = 120.0
    TELEGRAM_MEDIA_CONNECT_TIMEOUT_SECONDS: float = 20.0
